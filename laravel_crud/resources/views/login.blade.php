...
<body>
    ...
    <div class="mx-auto w-[600px] p-10 bg-white my-10 rounded-md shadow-lg">
        <h2 class="text-3xl font-medium text-cyan-500 text-center font-serif uppercase">Login Form</h2>
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div>
                <button type="submit"
                    class="bg-cyan-600 w-full text-center font-medium font-serif text-2xl text-white py-2 mt-2 uppercase hover:bg-green-500 transition-all">Login</button>
            </div>
            <p class="mt-3 text-black">You haven't account? <a href="{{ route('register') }}"
                    class="text-cyan-500 text-xl">Register</a> </p>
        </form>
    </div>
</body>
