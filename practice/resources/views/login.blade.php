...
<body>
    ...
    <h2 class="text-4xl text-cyan-500 text-center uppercase font-medium font-serif">Login Form</h2>
    @if (session('success'))
        <script>
            Swal.fire({
                title: 'Success!',
    ...
    <div>
        <form action="" method="post" enctype="multipart/form-data" class="bg-gray-900 p-10 w-1/2 mx-auto rounded-md ">
            ...
            <p class="mt-4 text-white">You haven't an account? go <a class="text-sky-500"
